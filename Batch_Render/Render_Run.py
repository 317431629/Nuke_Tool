...
# 导入外部数据
with open("C:/Users/Administrator/.nuke/Batch_Render/Data/write_Data.json", "r") as f:
    Write_volue = json.load(f)

with open("C:/Users/Administrator/.nuke/Batch_Render/Data/Path_Data.json", "r") as f:
    Path_Data = json.load(f)

with open("C:/Users/Administrator/.nuke/Batch_Render/Data/Render_Data.json", "r") as f:
